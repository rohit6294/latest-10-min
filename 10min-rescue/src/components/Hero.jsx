          ...
          <div className="text-center lg:text-left overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start mb-8 sm:mb-10 px-2 sm:px-0">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 sm:gap-3 bg-green-500 hover:bg-green-600 text-white font-bold text-base sm:text-lg px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl transition-all hover:shadow-2xl hover:shadow-green-500/40 hover:-translate-y-1"
              >
